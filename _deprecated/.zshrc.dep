...
# # Install micro, zoxide, zsh, and Fira Code font
# sudo apt install micro zoxide zsh fonts-firacode -y

# # Install oh-my-zsh
# sh -c "$(curl -fsSL https://raw.githubusercontent.com/ohmyzsh/ohmyzsh/master/tools/install.sh)"

# # Clone zsh-autosuggestions and zsh-syntax-highlighting into the custom plugins directory
